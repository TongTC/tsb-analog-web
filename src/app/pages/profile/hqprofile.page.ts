        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              Kanto, Kanagawa, Hokuriku, Tokai, Mie, Mikawa, Shiga, South Osaka,
              Kobe, Himeji, Shikoku, Hiroshima, Okayama,　Kyushu, Tokyo
              Distribution Center
            </td>
          </tr>
          <tr>
            ...
            <td>
              KENDEN INDUSTRY CO., LTD. TACHIBANA KOUWA System Service Co., Ltd.
              DAIDENSHA Co, Ltd. TACHIBANA DEVICE COMPONENT Co., Ltd. TAKAGI
              CONNECT Corp. TACHIBANA ELECTRONIC SOLUTIONS CO., Ltd.
            </td>
          </tr>
        </tbody>
      </table>
...
<div class="container ">
  <div class="row">
    <div class="col-2 border border-2 border-dark  m-1">
      <div class="row ">
        <img class="" src="/fas.png" alt="icon for fa" style="margin: auto; width: 65px; height: auto" />
      </div>
      <div class="row ">
    ...
    <div class="col border border-2 border-dark m-1">
      <p>
        ...
        Sells PLC, inverters, AC servos, power distribution control equipment
        and control devices, and a wide range of motors.
      </p>
      <p>
        <u><b>FA System Solution Department</b></u> <br />
        Builds systems and offers solutions for production equipment monitoring,
        measurement, and control. Also sells robot systems.
      </p>
      <p>
        <u><b>Industrial Mechatronics Department </b></u> <br />
        Sells a wide range of machine tools such as electric discharge machines,
        laser beam machines, machining centers, and 3D printers.
      </p>
      <p>
  ...
  <div class="row">
    <div class="col-2 border border-2 border-dark m-1">
      <div class="row ">
        <img class="mt-4 mb-4 img-fluid" src="/semicon_elec_device.png"
  ...
  <div class="row">
    <div class="col-2 border border-2 border-dark m-1">
      <div class="row">
        <img class="mt-4 mb-4 img-fluid" src="/bd_service.png"
          style="margin: auto; width: 65px; height: auto" />
      </div>
      <div class="row">
    ...
    <div class="col border border-2 border-dark m-1">
      <p>
        Sells lighting, air conditioning, elevators, and disaster preparedness
        equipment for factories, office buildings and stores. Also sells
        energy　efficient equipment for all-electric housing.
      </p>
    </div>
  </div>
  ...
  <div class="row ">
    ...
    <div class="col-2 border border-2 border-dark m-1">
      <div class="row"> <img class="mt-4 mb-4 img-fluid" src="/manufac_service.png"
          style="margin: auto; width: 65px; height: auto" /></div>
      <div class="row "><b>Manufacturing Services </b></div>

    </div>
    <div class="col border border-2 border-dark m-1">
      <p>
        Provides Electronics Manufacturing Services (EMS) that covers the design
        and manufacturing contracts for the substrate for electronic　devices to
        finished products, as well as provides Metal Manufacturing　Services
        (MMS) used to process and manufacture metal components　for multi-level
        car parking towers and railway cars.
      </p>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-2 border border-2 border-dark m-1">
      <div class="row "> <img class="mt-4 mb-4 img-fluid" src="/oversea_op.png"
          style="margin: auto; width: 65px; height: auto" /></div>
